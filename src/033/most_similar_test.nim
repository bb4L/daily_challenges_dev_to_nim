...
suite "similar test":
    test "fruits strawbery":
        check(most_similar(@["cherry", "pineapple", "melon", "strawberry",
    ...
    test "things":
        check(most_similar(@["stars", "mars", "wars", "codec", "codewars"],
                "coddwars") == "codewars")

    test "languages heaven":
        check(most_similar(@["javascript", "java", "ruby", "php", "python",
